    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr] items-start">
        ...
        <div className="space-y-4">
          ...
          {/* Product Form */}
          {(showAddForm || form.id) && (
            <Card className="rounded-lg border border-ia-outline-variant bg-ia-surface-card overflow-hidden ia-slide-up" style={{ boxShadow: "var(--shadow-card)" }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-4" id="product-form">
                  ...
                  <div className="flex gap-2.5 pt-1">
                    <Button
                      ...
                      type="submit"
                      disabled={isSaving}
                      className="h-9 px-4 rounded-md bg-ia-primary-container text-ia-on-primary font-semibold text-xs transition-all hover:bg-ia-primary active:scale-[0.97] cursor-pointer flex-1"
                      style={{ boxShadow: "var(--shadow-card)" }}
                    >
        ...
        <Card className="rounded-lg border border-ia-outline-variant bg-ia-surface-card overflow-hidden" style={{ boxShadow: "var(--shadow-card)" }}>
          <CardHeader className="ia-well">
            <CardTitle className="font-heading text-sm font-semibold tracking-tight text-ia-on-surface flex items-center gap-2">
                    ...
                    filteredProducts.map((product, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell className="py-3.5 px-4 font-mono text-xs text-ia-secondary tabular-nums">
                          ...
                          {/* Row actions — always visible for clarity */}
            ...
            {products.length > 0 && (
              <div className="px-4 py-3 border-t border-ia-outline-variant bg-ia-surface-high flex items-center justify-between">
                ...
                {tableSearch && (
                  <button
                    onClick={() => setTableSearch("")}
                    className="text-[11px] text-ia-primary-container hover:text-ia-primary font-medium transition-colors cursor-pointer"
                  >
                    Clear filter
                  </button>
                )}
