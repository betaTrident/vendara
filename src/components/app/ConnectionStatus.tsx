...
export const ConnectionStatus = ({ isOnline: isOnlineProp }: { isOnline?: boolean } = {}) => {
  ...
  return (
    <span
      className="inline-flex items-center gap-1.5 rounded-full border border-hairline bg-white px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide text-muted-text"
      role="status"
      aria-live="polite"
    >
      <span
