...
> Project-specific rules for this repository. Extends the common rules.
...
- Use `run-with-flags.js` wrapper for hook scripts that need shared parsing or runtime gating.
